...
Bai: Draw The Triangle 1
File: E:\HackerRank-SQL-Solutions\Alternative Queries\Draw The Triangle 1.sql

1) Muc tieu:
- Truy van nay giai bai toan 'Draw The Triangle 1' tren HackerRank.
