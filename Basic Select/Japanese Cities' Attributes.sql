...
Bai: Japanese Cities' Attributes
File: E:\HackerRank-SQL-Solutions\Basic Select\Japanese Cities' Attributes.sql

1) Muc tieu:
- Truy van nay giai bai toan 'Japanese Cities' Attributes' tren HackerRank.
