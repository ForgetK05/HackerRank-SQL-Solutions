...
Bai: Weather Observation Station 11
File: E:\HackerRank-SQL-Solutions\Basic Select\Weather Observation Station 11.sql

1) Muc tieu:
- Truy van nay giai bai toan 'Weather Observation Station 11' tren HackerRank.
...
- Dòng 4: LOWER(): Chuyển chuỗi về chữ thường.
- Dòng 5: ORDER BY: Sắp xếp kết quả theo cột/biểu thức chỉ định.
*/
